      ...
      <div className="container-xl">
        <div className="glass p-10 md:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-surface-400 max-w-2xl mx-auto mb-2 text-lg leading-relaxed">
            ...
            <p className="text-surface-300 max-w-2xl mx-auto text-lg leading-relaxed font-medium">
            ...
            <div className="flex items-center justify-center gap-2 mt-4">
              ...
              <span className="text-sm text-surface-400">Free consultation. No obligation. No hard sell.</span>
            </div>

            {/* Scarcity */}
            <p className="text-xs text-warm-400 font-medium mt-3">
              Currently accepting only 2 new clients this quarter
            </p>

            {/* Trust signals */}
            <div className="flex flex-wrap items-center justify-center gap-8 mt-10 pt-8 border-t border-surface-700/40">
              {[
                { value: '50+', label: 'Dashboards Delivered' },
