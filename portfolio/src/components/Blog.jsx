...
export default function Blog() {
  return (
    <section id="blog" className="section-pad bg-card/20">
          ...
          {posts.map((post) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-bold text-heading mb-2 group-hover:text-accent-soft transition-colors line-clamp-2">
                  {post.title}
                </h3>
