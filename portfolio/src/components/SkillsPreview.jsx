          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
            ...
            <div className="space-y-2">
              {certifications.map((cert) => (
                <a key={cert.name} href={cert.url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-body hover:text-accent transition-colors">
